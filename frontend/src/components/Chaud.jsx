...
function Chaud() {
    ...
    return (
        <div className="flex flex-col gap-5 lg:bg-gradient-to-br from-[#EE5C2B] to-accent-orange/30 lg:text-white rounded-2xl lg:p-6 lg:shadow-lg">
            <div className="hidden lg:flex items-center gap-4">
                <div className="bg-white/20 backdrop-blur-sm rounded-full lg:p-3">
                    <img
                ...
                <div>
                    ...
                    <p className="hidden lg:block">L'actualité brûlante qui fait parler</p>
                </div>
            </div>
            <div className="grid lg:grid-cols-4 gap-4">
                {Infos.map((info, index) => (
                    <InfoCard key={index} props={info} hrColor="#EE5C2B" />
                ))}
            </div>
        </div>
    );
